...
<center><h1 style="margin-left: 200px; margin-top: 50px;"><strong>Update Skin Care </strong></h1></center>
		...
		<form name="up_pro" method="post">
		  ...
		  <div class="form-group">
		    ...
		    <select class="form-control" name="cat">
		    	<option value="face" <?php if($row['cat']=='face'){echo "selected";}?>>Face</option>
		    	<option value="body"  <?php if($row['cat']=='body'){echo "selected";}?>>Body</option>
...
extract($_POST);
 ...
 // $photo=$row['Photo'];
 // }
$update = mysqli_query($connect,"update skin set
name='".$name."',
price='".$price."',
brand='".$brand."',
