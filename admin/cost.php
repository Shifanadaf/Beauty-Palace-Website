...
<aside>
 ...
 <center><h1 style="margin-left: 200px; margin-top: 50px;"><strong>View Cosmetics Products</strong></h1></center>
...
<tbody>
  <?php
   ...
   $view = mysqli_query($connect,"select * from cost order by id desc") or die(mysqli_error($connect));
...
href="u_cost.php?id=<?php echo $id;$cat;?>"
...
if (isset($_GET['id']))
{
$sel=mysqli_query($connect,"select * from cost where
id='".$_GET['id']."' ");
while ($fetch=mysqli_fetch_array($sel))
 ...
 $delete = mysqli_query($connect,"delete from cost where
id='".$_GET['id']."'");
