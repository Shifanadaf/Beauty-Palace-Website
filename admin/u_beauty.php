...
<center><h1 style="margin-left: 200px; margin-top: 50px;"><strong>Update Beauty Care </strong></h1></center>
    ...
    <form name="up_pro" method="post">
      ...
      <div class="form-group">
        ...
        <select class="form-control" name="cat">
          <option value="frag" <?php if($row['cat']=='frag'){echo "selected";}?>>Fragrances</option>
          <option value="tool"  <?php if($row['cat']=='tool'){echo "selected";}?>>Tools&accesories</option>
...
extract($_POST);
 ...
 // $photo=$row['Photo'];
 // }
$update = mysqli_query($connect,"update beauty set
name='".$name."',
price='".$price."',
brand='".$brand."',
