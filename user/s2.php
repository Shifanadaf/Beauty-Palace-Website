...
<center>
 ...
 <h2 style="margin-top: -10px; margin-bottom: 25px">Skin Care Products</strong></h2>
<!-- product inserted -->
...
<div class="row" style="margin-top:20px;">
  <?php
        $count=0;
        $fetch=mysqli_query($connect,"SELECT * FROM `skin` WHERE cat='body'") or die(mysqli_error($connect));
