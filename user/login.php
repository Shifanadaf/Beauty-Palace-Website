...
<center>
   ...
   <div class="container" style="margin-top: 150px;margin-left: 120px; " >
   <div class="form">
...
<div class="login-box"  >
 ...
 <a href="registration.php" class="btn btn-md btn-warning" id="btn1" value="Home" name="Home">Register</a>
...
if(isset($_POST['login']))
{
  ...
  $log=mysqli_query($connect,"select * from reg where email='$email' and pass='$pass'")
